...
myConfig =
    gnomeConfig
        ...
        , handleEventHook = handleEventHook gnomeConfig <> Hooks.rescueOffscreenHook <> Hooks.stripZoomFullscreenHook <> Hooks.floatZoomJoinPopupHook <> Hooks.raiseOsdOnLockHook <> WindowTags.windowTagEventHook
