    ...
    gnomeConfig
        ...
        , startupHook =
            composeAll
                ...
                , spawn "bash $HOME/.dotfiles/xwindow/bin/xmonad-lock-state"
        ...
        , handleEventHook = handleEventHook gnomeConfig <> Hooks.rescueOffscreenHook <> Hooks.stripZoomFullscreenHook <> Hooks.floatZoomJoinPopupHook <> Hooks.raiseHangulOsdOnLockHook <> WindowTags.windowTagEventHook
