...
- **Topology regression test**: `python3 xwindow/test_osd.py` simulates a RandR event and verifies that stale windows are destroyed and rebuilt from the new active-monitor geometry.
